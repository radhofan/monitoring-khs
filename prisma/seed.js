...
async function main() {
  ...
  const kontraks = [
    ...
    },
    {
      ...
      nomorAmandemenKontrak: 'REV-C6401',
      amandemenKontrakDetail: {
        nomorAmandemen: 'REV-C6401',
        nomorKontrak: 'K-D2401',
        tanggal: '01/03/2024',
        deskripsi: 'Penambahan fitur dokumen OCR dan indexing otomatis.',
      },
  ...
  for (const k of kontraks) {
    await prisma.kontrak.upsert({
      ...
      update: {
        ...
        amandemenKontrakDetail: k.amandemenKontrakDetail,
